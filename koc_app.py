...
# --- KULLANICI SİSTEMİ ---
KULLANICILAR = {"halil": "sahan26", "canan": "canan2026", "hafize": "hafize2026", "emrekurt": "kurt2026", "emine": "emine2026", "rabia": "rabia2026", "uğur": "uğur2026", "emre": "emre2026", "ahmet": "ahmet2026", "edanur": "edanur2026", "yalcın": "yalcın2026"  }
...
if st.session_state.user is None:
    ...
    # --- ÖĞRENCİ PANELİ ---
        ...
        with st.sidebar:
            if os.path.exists(LOGO_YOLU): st.image(LOGO_YOLU)
            st.title(f"MERHABA  {current_user.upper()}")
            if st.button("Çıkış"):
                st.session_state.user = None
                st.rerun()
